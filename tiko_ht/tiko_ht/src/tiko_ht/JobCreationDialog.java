...
public class JobCreationDialog extends Dialog {
	...
	private void createContents() {
		...
		GridData gd_customer_dropdown = new GridData(SWT.LEFT, SWT.CENTER, false, false, 2, 1);
		...
		GridData gd_jobName_field = new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1);
		...
		GridData gd_jobAddress_field = new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1);
		...
		btnCreateJob.addListener(SWT.Selection,new Listener() {
			...
			public void handleEvent(Event e) {
				db.connect();
				db.createJob(customer_dropdown.getText(),jobName_field.getText(), jobAddress_field.getText(),radioButton_pos.getSelection());
				shell.dispose();
			}
		});
		btnCreateJob.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
