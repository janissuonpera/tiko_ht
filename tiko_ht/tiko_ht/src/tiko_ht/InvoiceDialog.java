...
public class InvoiceDialog extends Dialog {
	...
	private void createContents() {
		...
		id_label.setFont(SWTResourceManager.getFont("Segoe UI", 11, SWT.NORMAL));
	...
	public void updateTexts() {
		...
		tunnit_text.setText(Double.toString(current_invoice.getTuntien_hinta()));
