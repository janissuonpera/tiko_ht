...
public class AddCustomer extends Dialog {
   ...
   private void createContents() {
      ...
      lblNimi.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1));
      lblNimi.setText("Nimi*");
      
      NameBox = new Text(shell, SWT.BORDER);
      NameBox.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 5, 1));
      ...
      lblOsoite.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1));
      lblOsoite.setText("Osoite*");
      
      Address = new Text(shell, SWT.BORDER);
      GridData gd_Address = new GridData(SWT.FILL, SWT.FILL, true, false, 5, 1);
      ...
      lblYritys.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1));
      ...
      GridData gd_NoButton = new GridData(SWT.CENTER, SWT.CENTER, true, false, 2, 1);
      ...
      YesButton.addSelectionListener(new SelectionAdapter() {
         ...
         public void widgetSelected(SelectionEvent e) {
            ...
            GridData gd_YesButton = new GridData(SWT.CENTER, SWT.CENTER, true, false, 3, 1);
      ...
      lblHetu.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1));
      lblHetu.setText("Hetu");
      
      Hetu = new Text(shell, SWT.BORDER);
      GridData gd_Hetu = new GridData(SWT.FILL, SWT.CENTER, true, false, 5, 1);
      ...
      lblVaaditutTiedot.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
      ...
      GridData gd_CancelAddCustomer = new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1);
   ...
   public void sendData() {
      try {
    	  ...
    	  db.connect();
    	  db.createCustomer(this.NameBox.getText(), this.Address.getText(),this.Company,this.Hetu.getText());
    	  db.closeConnection();
